...
public class CalculaView extends JFrame {
	...
	public void addCalculaListener (ActionListener listenerDoBotaoCalcuça) {
		botaoCalcula.addActionListener(listenerDoBotaoCalcuça);
	}
	
	public void exibeMensagemDeErro(String mensagemErro) {
		JOptionPane.showMessageDialog(this, mensagemErro, "Mensagem de erro: ", JOptionPane.ERROR_MESSAGE);
	}
